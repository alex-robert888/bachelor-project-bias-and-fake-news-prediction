  ...
  const [chromeStorageLocalState, setChromeStorageLocalState] = useChromeStorageLocalState(); 
    ...
    <section>
      ...
      <ul className="mt-6 space-y-4">
        <li>
          <DropdownContainer title="Biased/Deceptive Language" percentage={chromeStorageLocalState.biasedOrDeceptiveLanguage.score}>
            <></>
          </DropdownContainer>
        </li>

        <li>
          <DropdownContainer title="Source Reliability" percentage={chromeStorageLocalState.sourceReliability.score}>
            <>
