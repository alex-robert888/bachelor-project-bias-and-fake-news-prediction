...
class Model(object):
    ...
    def _fit_model(self) -> None:
        ...
        self._svm_classifier.fit(self._train_data.entries, self._train_data.labels)
    ...
    def _save_model_to_file(self) -> None:
        ...
        pickle.dump(self._svm_classifier, open(self._model_save_file_path, 'wb'))
    ...
    def _test_model(self) -> None:
        ...
        print("Test model")
        score = self._svm_classifier.score(self._test_data.entries, self._test_data.labels)
