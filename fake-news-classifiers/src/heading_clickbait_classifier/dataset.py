...
from src.heading_clickbait_classifier.data_leakages_clearer import DataLeakagesClearer
from src.heading_clickbait_classifier.data_pre_processor import DataPreProcessor
...
class Dataset(object):
    ...
    def __init__(self, csv_file_path: str = '../../dataset/headings-clickbait/Data.csv'):
        self._csv_file_path: Final = csv_file_path
        self._processed_csv_file_path: Final = "../../dataset/headings-clickbait/Processed-Data.csv"
    ...
    def _load_unprocessed_data(self) -> None:
        """ Read clickbait dataset. """
        data = pandas.read_csv(self._csv_file_path)
        self._data = data
